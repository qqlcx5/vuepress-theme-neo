import{_ as n,r,o,c as l,b as e,d,e as c,a as i}from"./app-DK9aT6cZ.js";const t={},s=i(`<h1 id="frontmatter-目录配置" tabindex="-1"><a class="header-anchor" href="#frontmatter-目录配置" aria-hidden="true">#</a> Frontmatter 目录配置</h1><p>假设这是你的 Markdown 文件所处的目录结构：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>doc
├─ README.md
├─ foo/
│   ├─ README.md
│   ├─ one.md
