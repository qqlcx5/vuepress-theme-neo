<template>
    <div class="site-info dark-shadow">
        <div class="site-info__title">
            <AIcon name="acme-pc" class="acme-mr-4" />
            本站信息
        </div>
        <div class="site-info__item">
            <div class="site-info__item-label">
                <AIcon name="acme-wenbenwenjian" class="acme-mr-4" />
                文章数目：
            </div>
        ...
        <div class="site-info__item">
            <div class="site-info__item-label">
                <AIcon name="acme-yun" class="acme-mr-4" />
                已运行时间：
            </div>
        ...
        <div class="site-info__item">
            <div class="site-info__item-label">
                <AIcon name="acme-wenku" class="acme-mr-4" />
                本站总字数：
            </div>
        ...
        <div class="site-info__item">
            <div class="site-info__item-label">
                <AIcon name="acme-shijian" class="acme-mr-4" />
                最后活动时间：
            </div>
        ...
        <div class="site-info__item">
            <div class="site-info__item-label">
                <AIcon name="acme-yonghuliang" class="acme-mr-4" />
                本站被访问了：
            </div>
            <div class="site-info__item-value">
                <span id="busuanzi_value_site_pv">
                    <AIcon name="acme-loading" class="acme-mr-4" spin />
                </span>
                次
            </div>
        </div>
        <div class="site-info__item">
            <div class="site-info__item-label">
                <AIcon name="acme-yuyan" class="acme-mr-4" />
                您的访问排名：
            </div>
            <div class="site-info__item-value">
