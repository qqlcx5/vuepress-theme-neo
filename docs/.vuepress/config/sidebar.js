...
// mock data
// '/utils/': [
//   { text: 'Array', collapsible: true, children: [Array] },
//   { text: 'Function', collapsible: true, children: [Array] },
//   { text: 'Number', collapsible: true, children: [Array] },
//   { text: 'String', collapsible: true, children: [Array] }
// ],
// '/interview/': [
// icon: 'el-icon-s-help',
// title: '面试题',
