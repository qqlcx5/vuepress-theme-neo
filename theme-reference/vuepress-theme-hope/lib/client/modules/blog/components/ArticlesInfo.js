    ...
    setup() {
        ...
        return () => h(DropTransition, () => h("div", { class: "vp-star-article-wrapper" }, [
            ...
            starredArticles.value.length
                ? h("ul", { class: "vp-star-articles" }, starredArticles.value.map(({ info, path }, index) => h(DropTransition, { appear: true, delay: 0.08 * (index + 1) }, () => h("li", { class: "vp-star-article" }, h(RouteLink, { to: path }, () => info[PageInfo.title])))))
